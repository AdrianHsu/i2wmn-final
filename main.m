...
for time = 1: simulation_time
  ...
  % Handoff  mechanism HERE!!!!!!!!!!!!!!!!!!! 
   ...
   %%%%%%%%% Criteria by Power %%%%%%%%%
%    figure;
%    nothing = Show_Specific_Mobile_Movement(mobile_coordinate,num_of_bs,3);

end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  show final position %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% figure;
for i = 1:50
    nothing = Show_Specific_Mobile_Movement(mobile_coordinate,num_of_bs, i);
end
